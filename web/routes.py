...
DASHBOARD_PATH = BASE_DIR / "dashboard" / "Dashboard_V4.xlsx"
WEIGHTS_PATH = BASE_DIR / "models" / "weights.json"
...
def read_backtest_rows(limit=120):
    ...
    with BACKTEST_PATH.open("r", encoding="utf-8-sig", newline="") as file:
...
def api_run_all():
    return JSONResponse(run_script("app/main.py"))


@router.post("/api/update")
def api_update():
    return JSONResponse(run_script("app/api_update.py"))


@router.post("/api/predict")
def api_predict():
    return JSONResponse(run_script("core/scorer.py"))


@router.post("/api/backtest")
def api_backtest():
    return JSONResponse(run_script("core/backtest.py"))


@router.post("/api/dashboard")
def api_dashboard():
    return JSONResponse(run_script("dashboard/dashboard_v4.py"))
